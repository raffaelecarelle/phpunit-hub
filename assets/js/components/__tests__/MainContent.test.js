...
describe('MainContent', () => {
  ...
  it('emits toggleTestDetails when IndividualTestResults emits it', async () => {
    mockStore.state.options.displayMode = 'individual';
    const wrapper = mount(MainContent, {
      props: {
        results: [{ id: 1 }],
  ...
  it('emits toggleTestDetails when GroupedTestResults emits it', async () => {
    mockStore.state.options.displayMode = 'default';
    const wrapper = mount(MainContent, {
      props: {
        results: [{ id: 1 }],
  ...
  it('emits toggleTestcaseGroup when GroupedTestResults emits it', async () => {
    mockStore.state.options.displayMode = 'default';
    const wrapper = mount(MainContent, {
      props: {
        results: [{ id: 1 }],
